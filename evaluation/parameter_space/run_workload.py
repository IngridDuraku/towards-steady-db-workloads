...
class ParameterSpaceExperiment:
    ...
    def generate_workloads(self):
        ...
        repetitiveness = [0.2, 0.4, 0.6, 0.8, 0.99]
        name2 = ["low1", "low2", "medium", "high", "very_high"]
        write_frequency = [0.01, 0.1, 0.3, 0.5, 0.8]
        name3 = ["low1", "low2", "medium", "high", "very_high"]

        config = self.config
        result = []

        for scan_size, write_size, n1 in zip(bytes_scanned, write_volume, name1):
            ...
            for r, n2 in zip(repetitiveness, name2):
                ...
                for wf, n3 in zip(write_frequency, name3):
                    ...
                    result_path = f"data/using_ratio_s3/workload_{n1}_{n2}_{n3}"
        ...
        result_df.to_csv(f"results/result_averaged_ratio_s3.csv", index=False)
